...
Para executar o projeto Back-end, basta acessar o diretório server e digitar no terminal ```npm start```. O servidor app deverá ser executado em http://localhost:3000.
